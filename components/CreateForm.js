...
<form action="" onSubmit={props.formHandler} className='flex flex-col justify-center bg-green-300 w-10/12 mx-auto p-2 my-6 rounded-xl'> 
          ...
          <input type="text" name='location' className='w-8/12' placeholder='Cookie Stand Location'/>
          ...
          <input type="number" name='minCustomers' className='py-2 px-6' placeholder='0'/>
          </div>
          <div className='py-2  mx-2 rounded text-center'>
          <label className='font-bold'>Maximum Customers per Hour</label>
          <input type="number" name='maxCustomers' className='py-2 px-6' placeholder='0'/>
          </div>
          <div className='py-2  mx-2 rounded text-center'>
          <label className='font-bold'>Average Cookies per Sale</label>
          <input type="number" name='avgCookies' className='py-2 px-6' placeholder='0'/>
          </div>
          </div>
        </form>
    )
